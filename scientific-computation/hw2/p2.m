...
fprintf('    %3.3f        %3.3f         %3.3f        %3.3f        %3.3f        %3.3f        %3.3f        \n', ax, pa_appx, pca_appx, pa_exact, pca_exact,  abs(pa_error), abs(pca_error))
fprintf('    %3.3f        %3.3f         %3.3f        %3.3f        %3.3f        %3.3f        %3.3f        \n', bx, pb_appx, pcb_appx, pb_exact, pcb_exact,  abs(pb_error), abs(pcb_error))